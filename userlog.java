...
public class userlog extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(userlog.class.getName());
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        String sql="SELECT * from log_in WHERE username=\""+ username +"\" AND password=\""+ password+"\"";
        System.out.print(sql);
        DatabaseManager dbm=new DatabaseManager();
        boolean userallowed= dbm.userAllowed(sql);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new userlog().setVisible(true));
    }
